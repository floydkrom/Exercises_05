...
covid <- covid19 %>%
  ...
  filter(cases>20) %>%
  ggplot() +
  geom_path(aes(x = cases, y = past7_cases, group = state)) +
  geom_point(aes(x = cases, y = past7_cases, group = state)) +
  geom_text(aes(x = cases, y = past7_cases, label = state) +
